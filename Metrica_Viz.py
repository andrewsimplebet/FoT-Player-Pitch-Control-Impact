...
Module for visualising Metrica tracking and event data. Original code generated by Laurie Shaw (@EightyFivePoint), with
modifications added to incorporate analysis from other files
